    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="logo text-center">
                            <h1>Web Education</h1>
                            <span>Your Online Major Resource</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="copyright text-center">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div>Developed by Beiwen Liu and Abhay Dalmia</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title text-center">
                            <h3>Our Awesome Majors</h3>
                            <p>Choose below which field you are interested in</p>
                        </div>
                    </div>
                    <div class="row">
